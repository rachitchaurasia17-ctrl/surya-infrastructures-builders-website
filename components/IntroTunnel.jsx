/* ───────────────────── IntroTunnel ─────────────────────
   ...
   Sequence:
     ...
     2. 'reveal'  — tunnel ends on a clean screen; the
                    Surya Infrastructures & Builders lockup fades in
                    and holds.
     3. 'out'     — the whole thing dissolves (fade + scale +
                    blur) into the landing page.
     4. 'gone'    — unmounts and calls onDone().

   Customised for Surya Infrastructures & Builders (blue room, brand phrase).
*/
...
const PHRASE = 'Surya Infrastructures & Builders · '; // tiled on all 4 walls
  ...
  return (
    <div className={"intro-tunnel intro-" + phase + (phase === "out" ? " intro-fade" : "")}>
      ...
      <div className="intro-center">
        <div className="intro-logo"><span>Surya Infrastructures & Builders</span><span>REALTY</span></div>
